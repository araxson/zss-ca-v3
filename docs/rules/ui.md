...
**Mission:** Audit and refactor UI components to strictly follow `docs/rules/ui.md` patterns without altering primitives. Apply fixes directly without generating reports.
...
## Strict Rules from docs/rules/ui.md
...
- Progress tracking → Use **Progress**, **Stepper**, or **Timeline** instead of Cards
- Key-value pairs → Use **Description List** patterns instead of Cards
...
## Inputs
- **Pattern rules:** `docs/rules/ui.md` (source of truth)
...
2. **Read `docs/rules/ui.md`** - Get all rules and approved patterns
