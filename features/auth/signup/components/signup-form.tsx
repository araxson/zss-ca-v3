...
import { signupSchema, type SignupInput } from '../api/schema'
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <FieldGroup className="gap-4">
                  <SignupEmailField control={form.control} loading={loading} />
                  <SignupCompanyField control={form.control} loading={loading} />
                  <SignupPasswordField
